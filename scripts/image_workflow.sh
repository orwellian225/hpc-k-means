...
build/kmeans-serial 3 $num_points data/$file_name results/$serial_file_name $4 100
mpiexec -np 2 build/kmeans-mpi 3 $num_points data/$file_name results/$mpi_file_name $4 100
build/kmeans-cuda 3 $num_points data/$file_name results/$cuda_file_name $4 100
